...
//     snow::log::info("n_elements: {}, full: {}, empty: {}", buffer.n_elements(), buffer.is_full(), buffer.is_empty());
...
//     v = buffer.pop_front(); snow::log::info("value: {}", *v);
//     v = buffer.pop_front(); snow::log::info("value: {}", *v);
...
//     buffer.push_back(std::make_unique<int32_t>(400));
//     buffer.push_back(std::make_unique<int32_t>(500));
//     snow::log::info("offset front 0: {}", *buffer.offset_front(0));
//     snow::log::info("offset front 1: {}", *buffer.offset_front(1));
//     snow::log::info("offset front 2: {}", *buffer.offset_front(2));
//     snow::log::info("offset front 3: {}", *buffer.offset_front(3));
//     snow::log::info("offset front 4: {}", *buffer.offset_front(4));
//     snow::log::info("offset back 0: {}", *buffer.offset_back(0));
//     snow::log::info("offset back 1: {}", *buffer.offset_back(1));
//     snow::log::info("offset back 2: {}", *buffer.offset_back(2));
//     snow::log::info("offset back 3: {}", *buffer.offset_back(3));
//     snow::log::info("offset back 4: {}", *buffer.offset_back(4));
// }
