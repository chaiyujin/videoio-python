...
inline void TestCircleBuffer() {
    ...
    spdlog::info("n_elements: {}, full: {}, empty: {}", buffer.n_elements(), buffer.is_full(), buffer.is_empty());
    ...
    v = buffer.pop_front(); spdlog::info("value: {}", *v);
    v = buffer.pop_front(); spdlog::info("value: {}", *v);
    ...
    buffer.push_back(std::make_unique<int32_t>(400));
    buffer.push_back(std::make_unique<int32_t>(500));
    spdlog::info("offset front 0: {}", *buffer.offset_front(0));
    spdlog::info("offset front 1: {}", *buffer.offset_front(1));
    spdlog::info("offset front 2: {}", *buffer.offset_front(2));
    spdlog::info("offset front 3: {}", *buffer.offset_front(3));
    spdlog::info("offset front 4: {}", *buffer.offset_front(4));
    spdlog::info("offset back 0: {}", *buffer.offset_back(0));
    spdlog::info("offset back 1: {}", *buffer.offset_back(1));
    spdlog::info("offset back 2: {}", *buffer.offset_back(2));
    spdlog::info("offset back 3: {}", *buffer.offset_back(3));
    spdlog::info("offset back 4: {}", *buffer.offset_back(4));
}
